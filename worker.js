...
// including the 18 legacy HubSpot slugs whose redirect targets were the old
// sixteen monthly pages.
const CHANGELOG_PATH = '/help/release-notes';
...
export default {
  async fetch(request, env) {
    ...
    if (match) {
      ...
      if (RELEASE_NOTES_PREFIX.test(resolved)) return Response.redirect(`${targetOrigin}${CHANGELOG_PATH}`, 301);
