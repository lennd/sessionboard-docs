...
sidebar:
  label: "Common CSV/XLSX import issues"
...
![6 common CSV & XLSX import issues (and how to fix them): Symptoms](/images/kb/a560b3c5-image-png-Mar-10-2026-09-05-08-8156-PM.png)
...
![6 common CSV & XLSX import issues (and how to fix them): Fix](/images/kb/ac361e12-image-png-Mar-10-2026-07-44-05-4207-PM.png)

- Add Day > Click on Day > Day with leading zero, add a slash: '/', add Month, etc.
  - This is how it needs to look before applying:

![6 common CSV & XLSX import issues (and how to fix them): Fix (2)](/images/kb/060585d6-image-png-Mar-25-2026-07-52-42-5116-PM.png)
...
![6 common CSV & XLSX import issues (and how to fix them): 'Session Friendly ID' field — what is it and where does it come from?](/images/kb/2252ec46-image-png-Mar-10-2026-09-09-10-0478-PM.png)
...
![6 common CSV & XLSX import issues (and how to fix them): Custom fields not appearing during import mapping](/images/kb/cc4767a5-image-png-Mar-10-2026-09-13-01-3267-PM.png)
