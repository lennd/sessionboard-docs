...
sidebar:
  label: "Common speaker portal issues"
description: "Speaker or participant clicks portal link → gets 'You do not have access to the portal for this event' when logging in → other speakers accessing the same portal fine It almost always means the email."
---
...
![6 common speaker portal issues (and how to fix them): Fix](/images/kb/3aa9e143-image-png-Mar-11-2026-06-38-29-4517-PM.png)

3. Double-check their Portal Username field at the bottom of the contact record:

![6 common speaker portal issues (and how to fix them): Fix (2)](/images/kb/ff0796c4-image-png-Mar-11-2026-06-39-58-4300-PM.png)
...
![6 common speaker portal issues (and how to fix them): Fix (3)](/images/kb/ff0796c4-image-png-Mar-11-2026-06-39-58-4300-PM.png)
...
![6 common speaker portal issues (and how to fix them): Portal filters aren't picking up speakers or participant count shows 0](/images/kb/ed954288-image-png-Mar-11-2026-07-38-33-6719-PM.png)
#### Symptoms
...
5. If using a corporate email, the user's IT team may need to allowlist sessionboard.com
