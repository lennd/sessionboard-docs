...
![Where to find notification settings](/images/kb/a73588f6-image-png-Mar-24-2026-06-38-25-2401-PM.png)
...
![How notifications work](/images/kb/232d82c9-image-png-Mar-24-2026-06-41-20-0091-PM.png)
...
Sent to submitters who started an entry but have not completed it. Emails go out five days and one day before the program's submission deadline. Completed submissions are not reminded, and people who never started an entry are not emailed.

<Note>
This is the same cadence as [session submission forms](/sessions/submission-forms) draft reminders. The days cannot be changed — you can only turn the notification on or off and customize the copy. The toggle starts off, so turn it on before you need the nudges.
</Note>
...
![Review Invitation](/images/kb/fad0b426-image-png-Mar-24-2026-06-46-37-6950-PM.png)

### Reviewer Deadline Reminder

Sent to reviewers who have outstanding, incomplete reviews five days and one day before that round's review end date. The days cannot be changed — you can only turn the notification on or off and customize the copy. This notification starts on.
...
![Admin notifications](/images/kb/d04b1129-image-png-Mar-24-2026-06-50-05-2423-PM.png)
...
![Customizing email templates](/images/kb/3af37306-image-png-Mar-24-2026-07-09-26-0367-PM.png)
...
If your organization has a system email address configured, each notification also has a **From** field. Leave it blank — that is the default — and the notification sends from your organization's system email, the same address your event-level emails use. Fill it in only when a particular notification should come from somewhere else.

An address you type has to be on a sending domain your organization has authorized. Anything else is refused when you save, with a message naming the domain mismatch. If your organization has no system email at all, awards notifications send from a Sessionboard no-reply address.

<Tip>
Setting up a custom sending domain, or changing which address your organization sends from, is covered in [Add-on: custom email domain](/communications/add-on-custom-email-domain).
</Tip>
...
![Enabling and disabling notifications](/images/kb/c81cab4a-image-png-Mar-24-2026-07-10-58-5867-PM.png)
