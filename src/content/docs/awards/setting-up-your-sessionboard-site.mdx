...
![Where to find Sites](/images/kb/0a0ea304-image-png-Mar-26-2026-08-16-03-2030-PM.png)
...
When you already have a site you like, use **Copy configuration from** in the Add Site dialog to start the new site from an existing one. The copy brings over the site settings, branding, and custom pages — but not the slug (you choose your own URL) and not the programs published on the source site, so the new site starts empty and you link the right programs yourself. The source site is not changed.
...
![Creating a new site](/images/kb/216f6a2f-image-png-Mar-26-2026-08-19-38-6501-PM.png)
...
![Site URL & slug](/images/kb/2eafe0b8-image-png-Mar-26-2026-08-29-08-0072-PM.png)
...
- Standard Login — Submitters enter their email address and receive a login link (sometimes called a magic link). The link expires after 30 minutes. No password is required — they simply click the link in their email to access the portal. This is the default method and is enabled by default.
  ...
  ![Login methods](/images/kb/6029b2b7-image-png-Mar-26-2026-08-33-24-4390-PM.png)
...
![SSO Login — Single Sign-On via your organization's identity provider (SAML, OIDC, etc.)](/images/kb/03c822bd-image-png-Mar-26-2026-08-29-52-0663-PM.png)
...
- Primary Color — Used for section backgrounds, including the sign-in card and the logged-in portal's navigation.
- Accent Color — Used for buttons, links, and accent elements.
- Text Color — Used for the title, subtitle, and paragraph text drawn over those branded surfaces: the landing page hero, the sign-in, verify, and welcome cards, and the portal navigation. It is white until you set it. Sessionboard applies the color exactly as entered, so check that it stays readable against your gradient and Primary Color — a dark text color on a dark gradient is not corrected for you.
- Font Family — Choose any font from Google Fonts. The default is Inter.

Primary, Accent, and Text Color are set under Logged-In Experience in the site editor and apply to the landing page, sign-in, and logged-in portal alike. Evaluators see the same colors on the evaluator site.

![Branding settings](/images/kb/24136e9b-image-png-Mar-26-2026-08-35-23-0362-PM.png)
...
Enter your organization's website and click Generate — a bare domain like `example.com` works; you don't need to type `https://`. Sessionboard will scan the page and extract colors, logos, and text to populate your portal's branding fields automatically. This is particularly useful for getting started quickly — you can always fine-tune the generated values afterward. If the site can't be scanned (for example, a typo in the domain or a site that blocks automated requests), the dialog tells you exactly what went wrong so you can correct it.

![Generate Branding](/images/kb/37685da7-image-png-Mar-26-2026-08-41-22-8729-PM.png)
...
![Organization Portal](/images/kb/f4838aca-image-png-Mar-26-2026-08-45-28-4316-PM.png)
...
![Show 'Events' Page](/images/kb/0ad57afc-image-png-Mar-26-2026-08-46-56-7296-PM.png)
...
![Available Programs](/images/kb/3beaec9e-image-png-Mar-26-2026-08-54-15-0361-PM.png)
...
![Privacy Notice](/images/kb/cd763d7b-image-png-Mar-26-2026-09-40-04-8285-PM.png)
...
![Custom Pages](/images/kb/55ae407a-image-png-Mar-26-2026-09-40-27-1848-PM.png)

## Public voting

When an awards round is set to **Public voting**, the ballot uses this same Site. Copy the link from the round (**Copy link**) and share it. Voters sign in with a magic link or SSO, then score submissions on that round's scorecard. See [Managing submissions, reviewers & rounds](/awards/managing-submissions-reviewers-rounds).

![Awards vote cards in grid view, with a submission photo as the card thumbnail](/images/kb/public-vote-awards-grid.png)

Pasting the vote URL into Slack, LinkedIn, or similar shows a branded preview of the round or the individual submission. Search engines and AI assistants do not index these URLs.
...
![Full size preview](/images/kb/b1bd962d-undefined.jpeg)
...
![First-time registration](/images/kb/60cadd9d-image-png-Mar-26-2026-09-43-54-6318-PM.png)
...
![Logged-in portal](/images/kb/e943927f-image-png-Mar-26-2026-09-44-28-2613-PM.png)
...
- Incomplete — Submissions that have been started but not yet submitted. Each row shows the program name, category, last updated date, a Draft status badge, and a Continue button to resume where they left off.
  ...
  ![Tracking and continuing submissions](/images/kb/f15df083-image-png-Mar-26-2026-09-48-15-5433-PM.png)
...
![Complete — Submissions that have been successfully submitted](/images/kb/d17bbca5-image-png-Mar-26-2026-09-49-05-8277-PM.png)
