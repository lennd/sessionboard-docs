...
<Tip>
For step-by-step Claude and ChatGPT setup — including the correct server URL for US, EU, and Middle East regions — see [Connect Claude and ChatGPT to Sessionboard](/integrations/connect-ai-assistants).
</Tip>
